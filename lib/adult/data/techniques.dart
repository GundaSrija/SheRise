...
List<Technique> getTechniques() {
  List<Technique> techniques =  <Technique>[] ;
  Technique technique = Technique(title: '', imgUrl: '', videoUrl: '', description: '');

  technique.title = "Hammer Strike";
  technique.imgUrl = "assets/images/splash/te1.png";
  technique.videoUrl =
  ...
  technique = Technique(title: '', imgUrl: '', videoUrl: '', description: '');
  technique.title = "Groin Kick";
  technique.imgUrl = "assets/images/splash/te2.png";
  technique.videoUrl =
  ...
  technique = Technique(title: '', imgUrl: '', videoUrl: '', description: '');
  technique.title = "Alternatve Elbow Strikes";
  technique.imgUrl = "assets/images/splash/te5.png";
  technique.videoUrl =
  ...
  technique = Technique(title: '', imgUrl: '', videoUrl: '', description: '');
  technique.title = "Escape from a ‘bear hug attack’";
  technique.imgUrl = "assets/images/splash/te6.png";
  technique.videoUrl =
  ...
  technique = Technique(title: '', imgUrl: '', videoUrl: '', description: '');
  technique.title = "Escape with hands trapped";
  technique.imgUrl = "assets/images/splash/te7.png";
  technique.videoUrl =
  ...
  technique = Technique(title: '', imgUrl: '', videoUrl: '', description: '');
  technique.title = "Escape from side headlock";
  technique.imgUrl = "assets/images/splash/te8.png";
  technique.videoUrl =
