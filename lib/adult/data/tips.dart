...
List<Tip> getTips() {
  List<Tip> tips = <Tip>[];
  Tip tip = Tip(title: '', description: '', imgUrl: '');

  tip.title = "Push back & yell loudly";
  tip.imgUrl = "assets/images/splash/tip1.jpg";
  tip.description =
  ...
  tips.add(tip);
  tip = Tip(title: '', description: '', imgUrl: '');

  tip.title = "Use the heel of your palm to strike at the nose";
  tip.imgUrl = "assets/images/splash/tip2.jpg";
  tip.description =
  ...
  tip.imgUrl = "assets/images/splash/tip3.jpg";
  tip.description =
  ...
  tip.imgUrl = "assets/images/splash/tip4.jpg";
  tip.description =
  ...
  tip.imgUrl = "assets/images/splash/tip5.jpg";
  tip.description =
  ...
  tip.imgUrl = "assets/images/splash/tip6.jpg";
  tip.description =
  ...
  tip.imgUrl = "assets/images/splash/tip7.jpg";
  tip.description =
  ...
  tip.imgUrl = "assets/images/splash/tip8.jpg";
  tip.description =
