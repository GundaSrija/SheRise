...
import 'package:kiya/adult/adultCab.dart';
import 'package:kiya/chatPage.dart';
import 'package:lottie/lottie.dart';

class AdultNavBar extends StatefulWidget {
  final String name;
  const AdultNavBar({super.key, required this.name});
...
class _AdultNavBarState extends State<AdultNavBar> {
  ...
  Widget _buildHomeScreen(Size screenSize) {
                ...
                children: [
                  Row(
                    children: [
                      // Lottie Widget Here
                      Lottie.asset(
                        'assets/images/splash/10.json', // Provide your Lottie animation file path
