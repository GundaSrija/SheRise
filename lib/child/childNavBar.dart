...
import 'package:kiya/child/childPlay.dart';

class ChildNavBar extends StatefulWidget {
  final String name;
  const ChildNavBar({super.key, required this.name});
...
class _ChildNavBarState extends State<ChildNavBar> {
  int _currentIndex = 0; // Set default index to 0 for ChildHome
  @override
  ...
  Widget _buildChildScreen(Size screenSize) {
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(
                    child: Text(
                      "Unleash Your Math Whiz: Conquer Equations & Become Unstoppable!",
                      style: GoogleFonts.roboto(
                        textStyle: TextStyle(
            ...
            Row(
              ...
              children: [
                Text(
                  "Math adventure? Learn & blast off!",
                  style: GoogleFonts.roboto(
                    textStyle: TextStyle(
                      color: const Color(0xFF123C69),
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.pushNamed(context, '/childstudy');
                  },
                  child: Column(
                    children: [
                      Container(
            ...
            GestureDetector(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(
                      height: screenWidth *
                          0.05), // Add spacing between image and text
                  Text(
                    'S.O.S',
                    style: GoogleFonts.tiltNeon(
                      textStyle: TextStyle(
            ...
            SizedBox(
                height:
                    screenWidth * 0.05), // Add spacing between image and text
            ...
            Padding(
              ...
              child: Text(
                "You must take help from your parents to activate S.O.S",
                style: GoogleFonts.roboto(
                  textStyle: TextStyle(
                    color: const Color(0xFF123C69),
                    fontSize: screenWidth * 0.04,
